"""
Django settings for backend_trashure project.
...
SECRET_KEY = 'django-insecure-0i4p4)dk%&mu#ko_as%d4a$%plj%)j3fn_geul&)nz22e3-zn2'
...
WSGI_APPLICATION = 'backend_trashure.wsgi.application'
